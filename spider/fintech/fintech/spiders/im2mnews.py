...
class QuotesSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.im2m.com.cn/hot/index.htm']
    ...
    def parse(self, response):
        ...
        print('正在......')
        next = response.css('.pagecode .next::attr(href)').extract_first()
    ...
    def parse_url(self, response):
        ...
        item['abstract']=response.css('.entry-content.mb25 p::text').extract_first()
        item['type']='2'
        ...
        item['content']=response.css('.entry-content.mb25 p::text').extract()
        yield item
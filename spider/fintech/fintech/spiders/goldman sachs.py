...
class QuotesSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.bankingtech.com/subject/fintech/']
    ...
    def parse_url(self, response):
        ...
        item['abstract']=response.css('.columns.small-12.single-post-content_text-container .first_paragraph::text').extract_first()
        item['type']='2'
